...
// Create an enum of the sides so we don't have to call each side 0 or 1.
...
////////////////////////////////////////////////////////////////////
// NORMALIZE_PLANE FUNCTION
////////////////////////////////////////////////////////////////////

void normalize_plane(float frustum[6][4], int side)
{
	// Here calculate the magnitude of the normal to the plane (point A B C)
	// (A, B, C) is that same thing as the normal's (X, Y, Z).
	// To calculate magnitude you use the equation:  magnitude = sqrt( x^2 + y^2 + z^2)
	float magnitude = (float)sqrt( frustum[side][A] * frustum[side][A] + 
								   frustum[side][B] * frustum[side][B] + 
								   frustum[side][C] * frustum[side][C] );

	// Then divide the plane's values by it's magnitude.
...
////////////////////////////////////////////////////////////////////
// CALCULATE_FRUSTUM FUNCTION
////////////////////////////////////////////////////////////////////

void CFrustum::calculate_frustum()
{    
...
////////////////////////////////////////////////////////////////////
// POINT_IN_FRUSTUM	 FUNCTION
////////////////////////////////////////////////////////////////////

bool CFrustum::point_in_frustum( float x, float y, float z )
{
...
////////////////////////////////////////////////////////////////////
// SPHERE IN FRUSTUM FUNCTION
////////////////////////////////////////////////////////////////////

bool CFrustum::sphere_in_frustum( float x, float y, float z, float radius )
{ 
	// Go through all the sides of the frustum
	for(int i = 0; i < 6; i++ )	
	{
...
////////////////////////////////////////////////////////////////////
// CUBE_IN_FRUSTUM FUNCTION
////////////////////////////////////////////////////////////////////

bool CFrustum::cube_in_frustum( float x, float y, float z, float size )
{
	// This will sometimes say that a cube is inside the frustum when it isn't.
